...
public class ProdutoServiceTest {
    ...
    @BeforeEach
    void setup(){
        this.produto = new Produto(1L, "nome", "descricao", null, null, null, null);
    ...
    void deveBuscarProdutosPorIdDaCidade(){
        ...
        produtos.add(new Produto(1L, "nome", "descricao", null, null, cidade, null));
    ...
    void deveBuscarProdutosPorIdDaCategoria(){
        ...
        produtos.add(new Produto(1L, "nome", "descricao", null, null, null, categoria));
